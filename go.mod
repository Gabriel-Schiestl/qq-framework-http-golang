module github.com/Gabriel-Schiestl/qq-framework-http-golang

go 1.24.4

require (
	github.com/Gabriel-Schiestl/qq-framework-basic-golang v0.0.0-20250707135631-cd60100dfd64
	github.com/Gabriel-Schiestl/qq-framework-basic-kafka v0.0.0-20250707134740-ce0198ca2176
	github.com/Gabriel-Schiestl/qq-framework-db-golang v0.0.0-20250707133906-827bf1146ce9
